...
get_music_discussions<-function(musicid,n=100,verbose=TRUE,...){
  
  strurl=paste0('http://music.douban.com/subject/',musicid,'/discussion/')
...
#a<-get_music_discussions(musicid=3843530,n=40,verbose=F)